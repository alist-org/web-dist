import{aT as i,d5 as h,cO as e,d6 as d,d7 as o,d8 as n,d9 as p,da as m,db as t,dc as f,dd as F,de as v,df as u,dg as E,dh as M,di as H,dj as B}from"./index-bcc8ecfe.js";import{l as I,m as V,q as A,r as k}from"./index-25ad48d0.js";import{I as x}from"./Layout-03189e0a.js";import{a as D}from"./index-6c2445ad.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function L(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function P(a){return i({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":F,"exe,msi":v,apk:x,db:I,md:u,epub:V,iso:A,m3u8:t,"doc,docx":E,"xls,xlsx":M,"ppt,pptx":H,pdf:B,psd:L,ai:Z,url:k,cast:D},w=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(c).toLowerCase()))return r;if(e(c))return d}switch(a){case l.FOLDER:return f;case l.VIDEO:return t;case l.AUDIO:return m;case l.TEXT:return p;case l.IMAGE:return n;default:return o}},U=a=>w(a.type,a.name);export{P as A,l as O,U as g};
