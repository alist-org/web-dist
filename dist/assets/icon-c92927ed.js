import{aT as i,d6 as h,cP as e,d7 as d,d8 as o,d9 as n,da as p,db as m,dc as t,dd as f,de as F,df as v,dg as u,dh as E,di as M,dj as H,dk as B}from"./index-ad495dea.js";import{l as I,m as V,q as k,r as A}from"./index-d1778743.js";import{I as x}from"./Layout-bd4c7014.js";import{a as D}from"./index-5006958a.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function L(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function Z(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}function U(a){return i({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":F,"exe,msi":v,apk:x,db:I,md:u,epub:V,iso:k,m3u8:t,"doc,docx":E,"xls,xlsx":M,"ppt,pptx":H,pdf:B,psd:L,ai:Z,url:A,cast:D},w=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(h(c).toLowerCase()))return r;if(e(c))return d}switch(a){case l.FOLDER:return f;case l.VIDEO:return t;case l.AUDIO:return m;case l.TEXT:return p;case l.IMAGE:return n;default:return o}},O=a=>w(a.type,a.name);export{U as A,l as O,O as g};
