import{q as h,r as o,s as e,t as p,v as i,w as m,x as n,y as d,z as F,A as f,C as E,D as v,E as M}from"./index.23721abf.js";import{g as u,h as B,j as I,k as V}from"./index.aea71eda.js";import{al as t,bK as k,bL as x}from"./index.af742395.js";import{I as H}from"./Layout.9787268b.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function L(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}const A={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":d,apk:H,db:u,md:F,epub:B,iso:I,m3u8:i,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:D,ai:L,url:V},Z=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(A))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return x;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,k(a.name));export{l as O,S as g};
